...
%define api.namespace       {dsl::parsing::detail}
...
%code provides {
    dsl::parsing::detail::Parser::symbol_type yylex(dsl::parsing::detail::Parser::location_type& loc);
}
...
%param       { dsl::parsing::detail::Parser::location_type& loc }
