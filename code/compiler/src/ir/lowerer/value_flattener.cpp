...
std::vector<NoteEvent> flatten_value(const Value& value, const double start_beat, const double duration_beats) {
    ...
    std::visit(utils::overloaded{
                   [&](const NoteValue& kind) { detail::flatten_note_value(kind, start_beat, duration_beats, events); },
                   [&](const ChordValue& kind) { detail::flatten_chord_value(kind, start_beat, events); },
                   [&](const SequenceValue& kind) { detail::flatten_sequence_value(kind, start_beat, events); },
